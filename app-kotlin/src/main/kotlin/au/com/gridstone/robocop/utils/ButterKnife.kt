package au.com.gridstone.robocop.utils
...
fun <V : View> View.findView(id: Int): V = findViewById(id)

@Suppress("UNCHECKED_CAST")
fun <V : View> Activity.findView(id: Int): V = findViewById(id)

@Suppress("UNCHECKED_CAST")
fun <V : View> Dialog.findView(id: Int): V = findViewById(id)

@Suppress("UNCHECKED_CAST")
fun <V : View> Activity.findOptionalView(id: Int): V? = findViewById(id)
